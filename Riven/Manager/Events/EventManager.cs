namespace Flowers_Riven_Reborn.Manager.Events
{
    ...
    internal class EventManager
    {
        internal static void Init()
        {
            ...
            Obj_AI_Base.OnDoCast += DoCastManager.InitCombo;
            Obj_AI_Base.OnDoCast += DoCastManager.InitBurst;
            Obj_AI_Base.OnDoCast += DoCastManager.InitMixed;
            Obj_AI_Base.OnDoCast += DoCastManager.InitClear;
            Obj_AI_Base.OnDoCast += DoCastManager.InitJungle;
