namespace Flowers_ADC_Series.Utility
{
    ...
    internal class Humanizer : Program
    {
        ...
        private static void OnUpdate(EventArgs Args)
        {
            ...
            if (Move() && Enabled)
            {
                Utility.DelayAction.Add(1000,() => allTime = Utils.TickCount + randomTime);
            }
        ...
        private static bool Move()
        {
            ...
            {
                case Flowers_ADC_Series.Orbwalking.OrbwalkingMode.Combo:
                ...
                case Flowers_ADC_Series.Orbwalking.OrbwalkingMode.LaneClear:
