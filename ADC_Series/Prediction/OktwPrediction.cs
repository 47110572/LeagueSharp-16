    ...
    public static class OktwPrediction
    {
        ...
        public static class Prediction
        {
            ...
            internal static PredictionOutput WayPointAnalysis(PredictionOutput result, PredictionInput input)
            {
                ...
                if (totalDelay - input.Radius/2/input.Speed > 0.6 &&
                    (input.Unit.IsWindingUp || !input.Unit.CanMove || input.Unit.IsRooted))
                {
        ...
        internal static class UnitTracker
        {
            ...
            static UnitTracker()
            {
                ...
                AttackableUnit.OnEnterLocalVisiblityClient += OnEnterLocalVisiblityClient;
            }

            private static void OnEnterLocalVisiblityClient(AttackableUnit sender, EventArgs args)
            {
