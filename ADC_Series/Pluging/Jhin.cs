...
#pragma warning restore 618
        ...
        private static bool IsSpellHeroCollision(Obj_AI_Hero t, Spell QWER, int extraWith = 50)
        {
            foreach (
                var hero in
        ...
        {
            Game.ShowPing(Menu.GetBool("NormalPingKill") ? PingCategory.Normal : PingCategory.Fallback, PingLocation, true);
        }
    }
}
