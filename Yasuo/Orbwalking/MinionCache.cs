namespace Flowers_Yasuo
{
    ...
    {
        public static readonly List<Obj_AI_Base> AllMinionsObj = new List<Obj_AI_Base>();
        public static readonly List<Obj_AI_Base> MinionsListEnemy = new List<Obj_AI_Base>();
        public static readonly List<Obj_AI_Base> MinionsListAlly = new List<Obj_AI_Base>();
        public static readonly List<Obj_AI_Base> MinionsListNeutral = new List<Obj_AI_Base>();
