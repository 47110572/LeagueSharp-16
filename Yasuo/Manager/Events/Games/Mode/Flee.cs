        ...
        private static void WallJumpLogic()
        {
            ...
            if (jminions.Any())
            {
                foreach (var jungleMobs in jminions)
                {
                    ...
                    {
                        if (jungleMobs.CharData.BaseSkinName != "SRU_Razorbreak"
                    ...
                    {
                        if (jungleMobs.CharData.BaseSkinName == "SRU_KrugMini"
                            && jungleMobs.IsVisible && E.IsReady() && jungleMobs.IsValidTarget(E.Range)
                            && SpellManager.CanCastE(jungleMobs))
                        {
                            E.CastOnUnit(jungleMobs);
                    ...
                    {
                        if (jungleMobs.CharData.BaseSkinName != "SRU_Murkwolf"
                    ...
                    {
                        if (jungleMobs.CharData.BaseSkinName != "SRU_RazorbreakMini9.1.2"
